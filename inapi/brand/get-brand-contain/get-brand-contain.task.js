...
var URL_BASE, ID_STACK, STACK_COUNT, Yakuza, Q, _, getBrandContain;
 ...
 */
getBrandContain = Yakuza.task('Inapi', 'Brand', 'GetBrandContain');

/**
 * Builder of Bikes task, this builder pass data from Job.
 */
getBrandContain.builder(function (job) {
 ...
 * shop link.
 */
getBrandContain.main(function (task, http, params) {
